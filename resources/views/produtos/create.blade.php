...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Cadastre um novo produto de seguro</p>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select @error('linha') is-invalid @enderror" 
                    ...
                    <option value="Transportes" {{ old('linha') == 'Transportes' ? 'selected' : '' }}>Transportes</option>
                    <option value="Automóvel" {{ old('linha') == 'Automóvel' ? 'selected' : '' }}>Automóvel</option>
                    <option value="Vida" {{ old('linha') == 'Vida' ? 'selected' : '' }}>Vida</option>
                    <option value="Patrimonial" {{ old('linha') == 'Patrimonial' ? 'selected' : '' }}>Patrimonial</option>
                    <option value="Responsabilidade" {{ old('linha') == 'Responsabilidade' ? 'selected' : '' }}>Responsabilidade</option>
                    <option value="Saúde" {{ old('linha') == 'Saúde' ? 'selected' : '' }}>Saúde</option>
                    <option value="Previdência" {{ old('linha') == 'Previdência' ? 'selected' : '' }}>Previdência</option>
                    <option value="Rural" {{ old('linha') == 'Rural' ? 'selected' : '' }}>Rural</option>
                    <option value="Habitacional" {{ old('linha') == 'Habitacional' ? 'selected' : '' }}>Habitacional</option>
                    <option value="Marítimo" {{ old('linha') == 'Marítimo' ? 'selected' : '' }}>Marítimo</option>
                    <option value="Aviação" {{ old('linha') == 'Aviação' ? 'selected' : '' }}>Aviação</option>
                </select>
            ...
            <div class="col-12">
                ...
                <div class="form-text">
                    <span id="charCount">{{ strlen(old('descricao', '')) }}</span>/1000 caracteres
                </div>
                @error('descricao')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                                ...
                                <div class="card-body p-3">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               {{ in_array($seguradora->id, old('seguradoras', [])) ? 'checked' : '' }}>
    ...
    <div class="row">
        <div class="col-md-6">
            <ul class="list-unstyled">
                ...
                <li class="mb-2">
                    <i class="bi bi-check text-success me-2"></i>
                    Selecione o tipo correto para facilitar buscas
                </li>
            </ul>
        </div>
        <div class="col-md-6">
            <ul class="list-unstyled">
                <li class="mb-2">
                    <i class="bi bi-check text-success me-2"></i>
                    Detalhe bem as coberturas na descrição
                </li>
                <li class="mb-2">
                    <i class="bi bi-check text-success me-2"></i>
                    Produtos únicos facilitam cotações
                </li>
            </ul>
        </div>
    </div>
...
// Funções para selecionar/desmarcar todas as seguradoras
function selectAll() {
