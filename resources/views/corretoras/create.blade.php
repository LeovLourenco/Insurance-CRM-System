...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">Nova Corretora</h1>
        <p class="text-muted mb-0">Cadastre uma nova corretora no sistema</p>
    </div>
            ...
            <form action="{{ route('corretoras.store') }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-2"></i>Criar Corretora
                    </button>
                    <a href="{{ route('corretoras.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="modern-card p-4">
            ...
            <div class="mb-3">
                ...
                <ul class="list-unstyled small">
                    <li><i class="bi bi-check-circle text-success me-1"></i> Nome da corretora</li>
                </ul>
            </div>
            ...
            <div class="mb-3">
                ...
                <ul class="list-unstyled small">
                    <li><i class="bi bi-dash-circle text-muted me-1"></i> Email</li>
                    <li><i class="bi bi-dash-circle text-muted me-1"></i> Telefone</li>
                    <li><i class="bi bi-dash-circle text-muted me-1"></i> Seguradoras parceiras</li>
                </ul>
            </div>
            ...
            <div class="mb-3">
                <h6 class="small text-muted text-uppercase fw-bold">Dicas</h6>
                <ul class="list-unstyled small">
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <i class="bi bi-lightbulb text-warning me-1"></i> 
                        Você pode vincular seguradoras depois
                    </li>
                </ul>
            </div>
        </div>
